  ...
  return (
    <div className="">
      <div className="relative">
        ...
        <div className="absolute flex justify-between mt-4 main-container-width inset-x-0 bottom-[-28%] md:bottom-[-20%] lg:bottom-[-15%] mx-auto bg-[--lilac1] rounded-3xl">
          <img src={LisaCircleImg} alt="Lisa" className="w-32 h-32 rounded-full border-2" />
          <button className="bg-[--lilac2] hover:bg-[--lilac] text-white font-bold py-2 px-6 rounded-3xl cursor-pointer">Follow</button>
        </div>
      </div>
      <MainContainer />
    </div>
